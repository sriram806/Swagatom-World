...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <Link
        to="/"
        className="flex items-center self-center whitespace-nowrap text-lg sm:text-2xl font-bold dark:text-white"
      >
        <img
          ...
          alt="Logo"
        />
        <span className="ml-2 hidden md:flex text-2xl font-bold text-black dark:text-white">
          SWAGATOM WORLD
        </span>
      </Link>
      ...
      <Navbar.Collapse>
        ...
        <Navbar.Link as={Link} to="/projects" active={location.pathname === '/projects'}>
          Projects
        </Navbar.Link>
      </Navbar.Collapse>
    </Navbar>
